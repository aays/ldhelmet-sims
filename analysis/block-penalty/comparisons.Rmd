...
```{r}
load_ldhelmet_files <- function(block_dir) {
  
  full_dir <- paste0('data/macs-runs/ldhelmet_2k/', block_dir)
...
block_5 <- load_ldhelmet_files('block_5')
block_10 <- load_ldhelmet_files('block_10')
block_50 <- load_ldhelmet_files('block_50')
block_100 <- load_ldhelmet_files('block_100')
